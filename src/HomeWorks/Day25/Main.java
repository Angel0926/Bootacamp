...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(removeChar(new StringBuilder("xxdgxhsjdxshs"), 10));
        ...
        System.out.println(numOfDigits("8d1d4fd75dg4g", 0));
        ...
        System.out.println(identicalLetter("asdddksk ", 7, 0));
